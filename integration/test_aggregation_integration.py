...
from .integration_test_utils import setup_teardown_test, get_driver, append_return, test_base_time
...
def test_aggregate_and_query_with_different_fixed_windows(setup_teardown_test, partitioned_by_key, flush_interval):
    ...
    for table in tables:
        if isinstance(table, str):
            tmp_table = Table(table_name, get_driver(setup_teardown_test))
