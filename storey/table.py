...
class Table:
    ...
    def __init__(self, table_path: str, storage: Driver, partitioned_by_key: bool = True,
                 flush_interval_secs: Optional[int] = 300, max_updates_in_flight: int = 8, support_full_aggregation_query=True):
        ...
        self._support_full_aggregation_query = support_full_aggregation_query
